...
function shortCut1_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.30290191574161, 127.03556952960479), // 선의 꼭짓점 좌표
...
function longCut1_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.302372578197286, 127.03549878466886), // 선의 꼭짓점 좌표
...
function shortCut2_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.30040186702331, 127.04148419175641), // 선의 꼭짓점 좌표
...
function shortCut3_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.29957671677084, 127.03679454236335), // 선의 꼭짓점 좌표
...
function longCut3_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.29957671677084, 127.03679454236335),
...
function shortCut4_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.298990579896014, 127.03825486104999), // 선의 꼭짓점 좌표
...
function longCut4_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.298990579896014, 127.03825486104999),
      new Tmapv3.LatLng(37.29857791608742, 127.03959118219053),
      new Tmapv3.LatLng(37.2996814873113, 127.04018108315526),
    ],
    strokeColor: "#f78181",
...
function passage1_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.30118653969557, 127.03922315821453),
...
function passage3_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.30047245250004, 127.03927072321366),
...
function passage4_addPolyline() {
  const polyline = new Tmapv3.Polyline({
    path: [
      new Tmapv3.LatLng(37.29951676891172, 127.0338732843778),
